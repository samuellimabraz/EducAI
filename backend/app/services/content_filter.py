...
class ContentFilter:
    ...
    def __init__(self):
        ...
        self.educational_keywords = [
            'matemática', 'número', 'conta', 'problema', 'equação',
            'soma', 'subtração', 'multiplicação', 'divisão',
            'fração', 'decimal', 'geometria', 'álgebra',
            'calcular', 'resolver', 'exercício', 'tarefa',
            'ajuda', 'explicar', 'entender', 'aprender'
        ]
